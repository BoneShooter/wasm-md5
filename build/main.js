...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 15751312,
    DYNAMIC_BASE = 15751312,
    DYNAMICTOP_PTR = 22640;
...
var real__getMD5 = asm["_getMD5"];
asm["_getMD5"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__getMD5.apply(null, arguments);
};
...
var _getMD5 = Module["_getMD5"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_getMD5"].apply(null, arguments)
};
